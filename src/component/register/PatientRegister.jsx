...
const PatientRegister = () => {
  ...
  useEffect(() => {
    const saved = JSON.parse(localStorage.getItem("patientStep1"));
    if (saved) {
  ...
  useEffect(() => {
    const step1Data = { fullName, email, phone, password, confirmPassword, gender, age, dob, bloodGroup, address };
    localStorage.setItem("patientStep1", JSON.stringify(step1Data));
  }, [fullName, email, phone, password, confirmPassword, gender, age, dob, bloodGroup, address]);
