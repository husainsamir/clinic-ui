  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center py-8">
      ...
      <div className="w-11/12 md:w-3/4 bg-white p-4 rounded-lg shadow-md mb-6 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
        ...
        <Link to={'/'} className="flex justify-center sm:justify-end">
          <button className="w-full sm:w-auto bg-red-500 text-white px-5 py-2 rounded-lg hover:bg-red-600 transition">
            Logout
          </button>
        </Link>
      </div>
